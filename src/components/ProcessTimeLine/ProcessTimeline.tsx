  ...
  const steps: ProcessStep[] = [
    {
      ...
      description:
        "Passive asset discovery, domain mapping, and API path enumeration to structure a comprehensive target matrix without triggering live defenses.",
      icon: Search,
    ...
    },
    {
      ...
      description:
        "Combining automated configuration scanners with rigorous manual logical sequence verification to hunt edge-case bugs and permission leaks.",
      icon: Eye,
    ...
    },
    {
      ...
      description:
        "Executing precise, isolated attack payloads to verify critical impact levels on live databases, cloud containers, or server boundaries securely.",
      icon: ShieldAlert,
    ...
    },
    {
      ...
      description:
        "Compiling a prescriptive, developer-oriented vulnerability report paired with secondary confirmation reviews to certify complete system fortification.",
      icon: CheckCircle2,
